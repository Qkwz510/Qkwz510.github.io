      ...
      <div class="header">
        <ul class="nav nav-pills pull-right" role="tablist">
          <li role="presentation" class="active">
            <a href="https://www.iculture.cc/knowledge/pig=261">源码下载</a></li>
          <li role="presentation" class="active">
            <a href="https://www.iculture.cc/qun" >加入Q群</a></li>
        </ul>
        <img src="https://www.iculture.cc/logo.png" height="40px" align="left">
        </div>
<br>
<br>
<div class="panel panel-primary" style="margin:1% 1% 1% 1%;background: rgba(255, 251, 251, 0.7)">
 ...
 <script>
  function  create() {
      ...
      kd.href = surl + 'camera2/live/?from=www.iculture.cc&id='+myid.value+''; 
      kd.style = ''; 
      //kd.innerText = surl + '?id='+myid.value; 
	  kd.innerText = surl + 'camera2/live/?from=www.iculture.cc&id='+myid.value+'';
  }
     </script>
      <form>
      ...
      <div class="panel panel-primary" style="margin:1% 1% 1% 1%;background: rgba(255, 251, 251, 0.7)">
        ...
        <p style="text-align:center">
          <br>&copy; Designed by
          <a href="https://www.iculture.cc">猪头</a></p>
</div>
<script>
var _hmt = _hmt || [];
(function() {
